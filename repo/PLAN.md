...
- [ ] Set up folder structure: `src/db`, `src/store`, `src/types`, `src/components`, `src/pages`, `src/hooks`, `src/utils`, `src/crypto`
...
|---|---|---|
| Phase 1: Setup & Auth | In Progress | 7 / 27 |
